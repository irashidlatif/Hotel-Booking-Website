                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive-md">
                            <table class="table table-hover border">
                                ...
                                <tbody>
                                    <?php
                                    $q = "SELECT rr.*,uc.name AS uname,r.name AS rname FROM `rate_review` rr INNER JOIN `user_cred` uc ON rr.user_id = uc.id INNER JOIN `rooms` r ON rr.room_id = r.id ORDER BY `sr_no` DESC";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        $seen .= "<a href='?del=$row[sr_no]' class= 'btn btn-sm rounded-pill btn-danger ml-2'>Delete</a>";
