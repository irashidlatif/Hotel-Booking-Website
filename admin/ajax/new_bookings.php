...
if (isset($_POST['get_bookings'])) {
    ...
    $res = select($query, 'sssss', ["%$form_data[search]%", "%$form_data[search]%", "%$form_data[search]%", "booked", 0]);
    $i = 1;
    $table_data = "";
        ...
        $table_data .= "
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <b>Paid:</b> ₨  $data[trans_amt] in cents
                    <br>
                    <b>Date:</b> $date
                </td>
                <td>
...
if (isset($_POST['assign_room'])) {
    ...
    $res = update($query, 'iisi', $values);  // it will update 2 rows so it will return 2
    echo ($res == 2) ? 1 : 0;
}
...
if (isset($_POST['cancel_booking'])) {
    ...
    $values = ['cancelled', 0, $form_data['booking_id']];
    $res = update($query, 'sii', $values);
    echo $res;
}
