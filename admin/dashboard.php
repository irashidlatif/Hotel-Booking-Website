...
<body class="bg-light">
    ...
    $unread_reviews = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(sr_no) AS 'count' FROM `rate_review` WHERE `seen`=0"));
                ...
                <div class="row mb-3">
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-primary p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="total_amt">Rs5</h4>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-success p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="active_amt">Rs5</h4>
                        </div>
                    </div>
                    <div class="col-md-3 mb-4">
                        <div class="card text-center text-danger p-3">
                            ...
                            <h4 class="mt-2 mb-0" id="cancelled_amt">Rs5</h4>
                        </div>
                    </div>
                </div>
