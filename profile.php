                    ...
                    <form id="info-form">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="name" class="form-control shadow-none" required value="<?php echo $u_fetch['name'] ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Phone Number</label>
                                <input type="number" name="phonenum" class="form-control shadow-none" required value="<?php echo $u_fetch['phonenum'] ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Date of Birth</label>
                                <input type="date" name="dob" class="form-control shadow-none" required value="<?php echo $u_fetch['dob'] ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Pincode</label>
                                <input type="number" name="pincode" class="form-control shadow-none" required value="<?php echo $u_fetch['pincode'] ?>">
                            </div>
            ...
            <div class="col-md-4 mb-5 px-4">
                <div class="bg-white p-3 p-md-4 rounded shadow-sm">
                    <form id="profile-form">
                        ...
                        <input type="file" name="profile" accept=".jpg, .jpeg, .png, .webp" class="mb-4 form-control shadow-none" required>
                        <button type="submit" class="btn text-white custom-bg shadow-none">Save Changes</button>
                    </form>
                </div>
